...
type ChittyChatClient interface {
	...
	Join(ctx context.Context, in *Username, opts ...grpc.CallOption) (*Message, error)
	Leave(ctx context.Context, in *Username, opts ...grpc.CallOption) (*Message, error)
}
...
func (c *chittyChatClient) Join(ctx context.Context, in *Username, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
...
func (c *chittyChatClient) Leave(ctx context.Context, in *Username, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
...
type ChittyChatServer interface {
	...
	Join(context.Context, *Username) (*Message, error)
	Leave(context.Context, *Username) (*Message, error)
...
func (UnimplementedChittyChatServer) Join(context.Context, *Username) (*Message, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Join not implemented")
}
func (UnimplementedChittyChatServer) Leave(context.Context, *Username) (*Message, error) {
...
func _ChittyChat_Join_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChittyChatServer).Join(ctx, req.(*Username))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ChittyChat_Leave_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChittyChatServer).Leave(ctx, req.(*Username))
	}
	return interceptor(ctx, in, info, handler)
}
